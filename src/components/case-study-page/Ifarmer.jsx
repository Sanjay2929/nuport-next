...
const Ifarmer = ({ logo, title, description, path }) => {
  return (
    <div className="bg-darkGray rounded-[20px] p-[1.5px] hover:bg-[linear-gradient(215.83deg,_#288EA5_0.54%,_rgba(40,_142,_165,_0)_69.44%)] overflow-hidden group transition-all ease-in-out duration-300 h-full">
      <div className="sm:p-8 p-6 bg-darkBlue rounded-[20px] relative h-full flex flex-col justify-between">
        <div className="w-20 h-24 max-h-24 blur-[70px] bg-transparent group-hover:bg-moonstone transition-all ease-in-out duration-300  absolute end-0 top-0 rounded-full"></div>
        {/* <span>{logo}</span> */}
