...
const MakeSomething = () => {
  return (
    <div class=" grid lg:gap-6 gap-3 row-auto col-auto container mx-auto 2xl:max-w-[1500px] 2xl:px-0 px-5 md:pb-[167px] sm:pb-[100px] pb-20 overflow-hidden relative rounded-xl">
      {" "}
      <Image
        className="w-full min-w-[405px] pointer-events-none absolute top-[50%] start-[50%] translate-x-[-50%] translate-y-[-50%]"
        src="/assets/images/aboutpage/make-something/shape.webp"
        alt="man-1"
        width={455}
        height={511}
      />
      <Image
        ...
        src="/assets/images/aboutpage/make-something/man-1.webp"
        alt="man-1"
        width={412}
        height={379}
      />
      <Image
        ...
        src="/assets/images/aboutpage/make-something/something-2.webp"
        alt="man-1"
        width={412}
        height={204}
      />{" "}
      <Image
        ...
        src="/assets/images/aboutpage/make-something/nuport-3.webp"
        alt="man-1"
        width={411}
        height={107}
      />{" "}
      <Image
        ...
        src="/assets/images/aboutpage/make-something/man-bottom.webp"
        alt="man-1"
        width={412}
        height={379}
      />
      <Image
        ...
        src="/assets/images/aboutpage/make-something/nuport-4.webp"
        alt="man-1"
        width={412}
        height={326}
      />
      <Image
        ...
        src="/assets/images/aboutpage/make-something/rupor-bottom-2-3.webp"
        alt="man-1"
        width={412}
        height={326}
      />
      <Image
        ...
        src="/assets/images/aboutpage/make-something/man-2-3.webp"
        alt="man-1"
        width={412}
        height={204}
      />{" "}
      <Image
        ...
        src="/assets/images/aboutpage/make-something/make-last.webp"
        alt="man-1"
        width={411}
        height={107}
      />{" "}
