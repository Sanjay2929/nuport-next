...
const Revolution = ({ date, content, btn, img }) => {
  return (
    <div className=" border-2 border-tealBlue rounded-xl bg-lightTeal mb-[24px] overflow-hidden min-h-[287px] flex transition-all ease-in-out duration-300 shadow-lg hover:shadow-tealBlue ">
      <div className="flex flex-wrap">
        ...
        <div className=" sm:w-5/12 w-full">
          <Image
            src={img}
            className=" lg:rounded-e-xl rounded-b-xl lg:rounded-b-none lg:max-w-[559px] w-full h-full flex lg:max-h-[100%] max-h-[225px] object-cover object-top"
            width={559}
            height={449}
            alt="saas man"
          />
